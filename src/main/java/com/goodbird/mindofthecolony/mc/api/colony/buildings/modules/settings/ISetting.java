package com.goodbird.mindofthecolony.mc.api.colony.buildings.modules.settings;
...
public interface ISetting<S>
{
    ...
    {
        final String generalSettingToolTipKey = "com.goodbird.mindofthecolony.mc.coremod.setting.tooltip." + key.getUniqueId().toString();
