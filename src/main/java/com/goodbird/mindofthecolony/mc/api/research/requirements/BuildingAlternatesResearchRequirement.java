...
import static com.goodbird.mindofthecolony.mc.api.research.requirements.BuildingResearchRequirement.parseFallbackBuildingKey;
...
public class BuildingAlternatesResearchRequirement implements IResearchRequirement
{
    ...
    public MutableComponent getDesc()
    {
        ...
        while (iterator.hasNext())
        {
            ...
            requirementList.append(Component.translatable("com.goodbird.mindofthecolony.mc.coremod.research.requirement.building.level", buildingName, buildingLevel));

            if (iterator.hasNext())
            {
                requirementList.append(Component.translatable("com.goodbird.mindofthecolony.mc.coremod.research.requirement.building.or"));
            }
        }
