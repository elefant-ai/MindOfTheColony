...
/**
 * Defines a model type and its textures. Use the {@link com.goodbird.mindofthecolony.mc.api.client.render.modeltype.registry.IModelTypeRegistry} to register it, together with a Citizen model for
