package com.goodbird.mindofthecolony.mc.api.research.requirements;
...
import static com.goodbird.mindofthecolony.mc.api.research.ModResearchRequirements.BUILDING_SINGLE_RESEARCH_REQ_ID;
import static com.goodbird.mindofthecolony.mc.api.research.util.ResearchConstants.TAG_REQ_TYPE;
import static com.goodbird.mindofthecolony.mc.core.datalistener.ResearchListener.RESEARCH_REQUIREMENT_TYPE_PROP;
...
public class BuildingResearchRequirement implements IResearchRequirement
{
    ...
    public MutableComponent getDesc()
    {
        ...
        if (singleBuilding)
        {
            return Component.translatable("com.goodbird.mindofthecolony.mc.coremod.research.requirement.building.single.level", buildingName, buildingLevel);
        }
        else
        {
            return Component.translatable("com.goodbird.mindofthecolony.mc.coremod.research.requirement.building.level", buildingName, buildingLevel);
        }
    }
