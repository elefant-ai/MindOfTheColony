...
import static com.goodbird.mindofthecolony.mc.api.util.constant.HappinessConstants.IDLE_AT_JOB_COMPLAINS_DAYS;
import static com.goodbird.mindofthecolony.mc.api.util.constant.HappinessConstants.IDLE_AT_JOB_DEMANDS_DAYS;
...
public interface IJob<AI extends ITickingStateAI> extends INBTSerializable<CompoundTag>
{
     ...
     *
     * @return {@link com.goodbird.mindofthecolony.mc.api.colony.IColony} of the citizen.
     */
    IColony getColony();
