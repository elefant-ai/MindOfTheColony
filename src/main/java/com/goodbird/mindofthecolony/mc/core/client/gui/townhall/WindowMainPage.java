...
import com.goodbird.mindofthecolony.mc.core.client.gui.WindowBannerPicker;
import com.goodbird.mindofthecolony.mc.core.client.gui.map.WindowColonyMap;
import com.goodbird.mindofthecolony.mc.core.colony.buildings.workerbuildings.BuildingTownHall;
import com.goodbird.mindofthecolony.mc.core.network.messages.server.colony.ColonyNameStyleMessage;
import com.goodbird.mindofthecolony.mc.core.network.messages.server.colony.ColonyStructureStyleMessage;
import com.goodbird.mindofthecolony.mc.core.network.messages.server.colony.ColonyTextureStyleMessage;
import com.goodbird.mindofthecolony.mc.core.network.messages.server.colony.TeamColonyColorChangeMessage;
...
import static com.goodbird.mindofthecolony.mc.api.util.constant.Constants.TICKS_FOURTY_MIN;
import static com.goodbird.mindofthecolony.mc.api.util.constant.WindowConstants.*;
import static com.goodbird.mindofthecolony.mc.core.event.TextureReloadListener.TEXTURE_PACKS;
...
public class WindowMainPage extends AbstractWindowTownHall
{
    ...
    public void onUpdate()
    {
        ...
        else
        {
            ...
            final AbstractTextBuilder.TooltipBuilder textPaneToolTipBuilder = PaneBuilders.tooltipBuilder().hoverPane(textPane).append(Component.translatable("com.goodbird.mindofthecolony.mc.core.townhall.patreon.textures"))
                    .paragraphBreak()
                    .appendNL(Component.empty())
                    .appendNL(Component.translatable("com.goodbird.mindofthecolony.mc.core.townhall.patreon"))
                    .paragraphBreak();


            final AbstractTextBuilder.TooltipBuilder namePaneToolTipBuilder = PaneBuilders.tooltipBuilder().hoverPane(namePane)
                    .append(Component.translatable("com.goodbird.mindofthecolony.mc.core.townhall.patreon.names")).paragraphBreak()
                    .appendNL(Component.empty())
                    .appendNL(Component.translatable("com.goodbird.mindofthecolony.mc.core.townhall.patreon")).paragraphBreak();

            if (isFeatureUnlocked.get() && !isOwner)
            {
                textPaneToolTipBuilder.appendNL(Component.empty());
                namePaneToolTipBuilder.appendNL(Component.empty());
                textPaneToolTipBuilder.appendNL(Component.translatable("com.goodbird.mindofthecolony.mc.core.townhall.patreon.needs_owner"));
                namePaneToolTipBuilder.appendNL(Component.translatable("com.goodbird.mindofthecolony.mc.core.townhall.patreon.needs_owner"));
            }
