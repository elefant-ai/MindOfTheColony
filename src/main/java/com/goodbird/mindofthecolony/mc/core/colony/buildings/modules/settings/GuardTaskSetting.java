...
import static com.goodbird.mindofthecolony.mc.core.colony.buildings.AbstractBuildingGuards.PATROL_MODE;
import static com.goodbird.mindofthecolony.mc.core.colony.buildings.modules.settings.GuardPatrolModeSetting.MANUAL;
...
public class GuardTaskSetting extends StringSettingWithDesc
{
     ...
     */
    public static final String PATROL      = "com.goodbird.mindofthecolony.mc.core.guard.setting.patrol";
    public static final String GUARD       = "com.goodbird.mindofthecolony.mc.core.guard.setting.guard";
    public static final String FOLLOW      = "com.goodbird.mindofthecolony.mc.core.guard.setting.follow";
    public static final String PATROL_MINE = "com.goodbird.mindofthecolony.mc.core.guard.setting.patrol_mine";
    ...
    private void setPatrolMineHelpLabel(final ButtonImage button, final AbstractBuildingGuards.View building)
    {
        ...
        {
            component = Component.translatableEscape("com.goodbird.mindofthecolony.mc.coremod.gui.worherhuts.patrollingmine", building.getMinePos().toShortString());
        }
        else
        {
            component = Component.translatableEscape("com.goodbird.mindofthecolony.mc.coremod.job.guard.assignmine");
        }
