package com.goodbird.mindofthecolony.mc.core.entity.ai.workers.guard.training;
...
import com.goodbird.mindofthecolony.mc.core.colony.buildings.workerbuildings.BuildingArchery;
import com.goodbird.mindofthecolony.mc.core.colony.jobs.JobArcherTraining;
...
import static com.goodbird.mindofthecolony.mc.api.util.constant.Constants.HALF_BLOCK;
import static com.goodbird.mindofthecolony.mc.api.util.constant.GuardConstants.*;

import static com.goodbird.mindofthecolony.mc.api.util.constant.StatisticsConstants.ARROWS_FIRED;
import static com.goodbird.mindofthecolony.mc.api.util.constant.StatisticsConstants.ARROWS_HIT;
import static com.goodbird.mindofthecolony.mc.api.util.constant.StatisticsConstants.LEVELS_GAINED;
...
public class EntityAIArcherTraining extends AbstractEntityAITraining<JobArcherTraining, BuildingArchery>
{
    ...
    private final static VisibleCitizenStatus ARCHER_TRAIN =
      new VisibleCitizenStatus(new ResourceLocation(Constants.MOD_ID, "textures/icons/work/archer_uni.png"), "com.goodbird.mindofthecolony.mc.gui.visiblestatus.archer_uni");
