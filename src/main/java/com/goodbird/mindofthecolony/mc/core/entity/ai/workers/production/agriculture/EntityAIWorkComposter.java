...
import com.goodbird.mindofthecolony.mc.core.colony.buildings.workerbuildings.BuildingComposter;
import com.goodbird.mindofthecolony.mc.core.colony.jobs.JobComposter;
import com.goodbird.mindofthecolony.mc.core.entity.ai.workers.AbstractEntityAIInteract;
import com.goodbird.mindofthecolony.mc.core.tileentities.TileEntityBarrel;
...
import static com.goodbird.mindofthecolony.mc.api.research.util.ResearchConstants.PODZOL_CHANCE;
import static com.goodbird.mindofthecolony.mc.api.util.constant.Constants.DOUBLE;
import static com.goodbird.mindofthecolony.mc.api.util.constant.Constants.TICKS_SECOND;
import static com.goodbird.mindofthecolony.mc.api.util.constant.TranslationConstants.COM_MINECOLONIES_COREMOD_ENTITY_COMPOSTER_EMPTYLIST;
import static com.goodbird.mindofthecolony.mc.api.util.constant.StatisticsConstants.ITEMS_COMPOSTED;
import static com.goodbird.mindofthecolony.mc.api.util.constant.StatisticsConstants.PRODUCT_COLLECTED;
...
public class EntityAIWorkComposter extends AbstractEntityAIInteract<JobComposter, BuildingComposter>
{
    ...
    private final static VisibleCitizenStatus COMPOST =
      new VisibleCitizenStatus(new ResourceLocation(Constants.MOD_ID, "textures/icons/work/composter.png"), "com.goodbird.mindofthecolony.mc.gui.visiblestatus.composter");
