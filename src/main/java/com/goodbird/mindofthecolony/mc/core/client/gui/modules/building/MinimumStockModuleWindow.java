...
import com.goodbird.mindofthecolony.mc.core.network.messages.server.colony.building.AddMinimumStockToBuildingModuleMessage;
import com.goodbird.mindofthecolony.mc.core.network.messages.server.colony.building.RemoveMinimumStockFromBuildingModuleMessage;
    ...
    private void addStock()
    {
        if (!moduleView.hasReachedLimit())
        {
            new WindowSelectRes(this,
                ...
                true,
                Component.translatable("com.goodbird.mindofthecolony.mc.coremod.gui.scan.select.stack")).open();
        }
    }
