...
import com.goodbird.mindofthecolony.mc.core.network.messages.server.colony.building.worker.ChangeRecipePriorityMessage;
import com.goodbird.mindofthecolony.mc.core.network.messages.server.colony.building.worker.ToggleRecipeMessage;
        ...
        recipeList.setDataProvider(new ScrollingList.DataProvider()
        {
            ...
            public void updateElement(final int index, @NotNull final Pane rowPane)
            {
                    ...
                    if (moduleView.isRecipeAlterationAllowed())
                    {
                        ...
                        if (recipe.getRecipeSource() != null && !Screen.hasControlDown())
                        {
                            ...
                            PaneBuilders.tooltipBuilder()
                                .append(Component.translatable("com.goodbird.mindofthecolony.mc.coremod.gui.workerhuts.removebuiltin",
                ...
                if (moduleView.isDisabled(recipe))
                {
                    ...
                    rowPane.findPaneOfTypeByID(BUTTON_TOGGLE, Button.class).setText(Component.translatableEscape("com.goodbird.mindofthecolony.mc.coremod.gui.recipe.enable"));
                ...
                else
                {
                    ...
                    rowPane.findPaneOfTypeByID(BUTTON_TOGGLE, Button.class).setText(Component.translatableEscape("com.goodbird.mindofthecolony.mc.coremod.gui.recipe.disable"));
