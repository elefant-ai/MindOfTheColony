...
import com.goodbird.mindofthecolony.mc.api.colony.interactionhandling.*;
...
import static com.goodbird.mindofthecolony.mc.core.colony.interactionhandling.StandardInteraction.*;
...
public class RequestBasedInteraction extends ServerCitizenInteraction
{
    ...
    private static final Tuple<Component, Component>[] tuples = (Tuple<Component, Component>[]) new Tuple[] {
      ...
      new Tuple<>(Component.translatableEscape("com.goodbird.mindofthecolony.mc.coremod.gui.chat.cancel"), Component.empty()),
      new Tuple<>(Component.translatableEscape("com.goodbird.mindofthecolony.mc.coremod.gui.chat.fulfill"), Component.empty())};
    ...
    {
        if (((TranslatableContents) getPossibleResponses().get(responseId).getContents()).getKey().equals("com.goodbird.mindofthecolony.mc.coremod.gui.chat.fulfill"))
        {
    ...
    public void onServerResponseTriggered(final int responseId, final Player player, final ICitizenData data)
    {
        ...
        if (response.equals(Component.translatableEscape("com.goodbird.mindofthecolony.mc.coremod.gui.chat.cancel")) && data.getColony() != null)
        {
