package com.goodbird.mindofthecolony.mc.core.entity.ai.workers.production.herders;
...
import com.goodbird.mindofthecolony.mc.core.colony.buildings.workerbuildings.BuildingCowboy;
import com.goodbird.mindofthecolony.mc.core.colony.jobs.JobCowboy;
...
import static com.goodbird.mindofthecolony.mc.api.util.constant.StatisticsConstants.MILKING_ATTEMPTS;
import static com.goodbird.mindofthecolony.mc.core.colony.buildings.workerbuildings.BuildingCowboy.MILKING_AMOUNT;
/**
...
public class EntityAIWorkCowboy extends AbstractEntityAIHerder<JobCowboy, BuildingCowboy>
{
    ...
    private final static VisibleCitizenStatus HERD_COW =
      new VisibleCitizenStatus(new ResourceLocation(Constants.MOD_ID, "textures/icons/work/cowboy.png"), "com.goodbird.mindofthecolony.mc.gui.visiblestatus.cowboy");
