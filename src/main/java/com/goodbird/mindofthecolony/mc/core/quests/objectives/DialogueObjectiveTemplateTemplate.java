...
import com.goodbird.mindofthecolony.mc.api.quests.IDialogueObjectiveTemplate;
...
import static com.goodbird.mindofthecolony.mc.api.quests.QuestParseConstant.TARGET_KEY;
import static com.goodbird.mindofthecolony.mc.api.quests.QuestParseConstant.UNLOCKS_REWARDS_KEY;
...
public class DialogueObjectiveTemplateTemplate implements IDialogueObjectiveTemplate
{
    ...
    public Component getProgressText(final IQuestInstance quest, final Style style)
    {
        ...
        if (citizen != null)
        {
            return Component.translatableEscape("com.goodbird.mindofthecolony.mc.coremod.questobjectives.answer.progress", citizen.getName()).setStyle(style);
        }
        else
        {
