...
import com.goodbird.mindofthecolony.mc.core.colony.buildings.modules.MinimumStockModule;
...
public class BuildingNetherWorker extends AbstractBuilding
{
    ...
    public static final ISettingKey<BoolSetting> CLOSE_PORTAL =
        new SettingKey<>(BoolSetting.class, new ResourceLocation(com.goodbird.mindofthecolony.mc.api.util.constant.Constants.MOD_ID, "closeportal"));
