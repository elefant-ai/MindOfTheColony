...
import static com.goodbird.mindofthecolony.mc.api.util.constant.TranslationConstants.TOWNHALL_BREAKING_DONE_MESSAGE;
...
public class BlockHutTownHall extends AbstractBlockHut<BlockHutTownHall>
{
    ...
    public List<MutableComponent> getRequirements(final ClientLevel level, final BlockPos pos, final LocalPlayer player)
    {
        ...
        {
            requirements.add(Component.translatableEscape("com.goodbird.mindofthecolony.mc.coremod.hut.cost", Component.translatableEscape("block." + Constants.MOD_ID + "." + getHutName())).setStyle((Style.EMPTY).withColor(
              ChatFormatting.RED)));
        }
