package com.goodbird.mindofthecolony.mc.core.colony.requestsystem.init;

import com.goodbird.mindofthecolony.mc.api.colony.requestsystem.StandardFactoryController;
import com.goodbird.mindofthecolony.mc.api.colony.requestsystem.factory.standard.IntegerFactory;
import com.goodbird.mindofthecolony.mc.api.colony.requestsystem.factory.standard.TypeTokenFactory;
import com.goodbird.mindofthecolony.mc.api.colony.requestsystem.token.InitializedTokenFactory;
import com.goodbird.mindofthecolony.mc.api.colony.requestsystem.token.RandomSeededTokenFactory;
import com.goodbird.mindofthecolony.mc.api.colony.requestsystem.token.StandardTokenFactory;
import com.goodbird.mindofthecolony.mc.core.colony.buildings.modules.settings.SettingsFactories;
import com.goodbird.mindofthecolony.mc.core.colony.crafting.ImmutableItemStorageFactory;
import com.goodbird.mindofthecolony.mc.core.colony.crafting.ItemStorageFactory;
import com.goodbird.mindofthecolony.mc.core.colony.crafting.RecipeStorageFactory;
import com.goodbird.mindofthecolony.mc.core.colony.requestsystem.data.*;
...
import com.goodbird.mindofthecolony.mc.core.colony.requestsystem.requesters.factories.BuildingBasedRequesterFactory;
import com.goodbird.mindofthecolony.mc.core.colony.requestsystem.requests.StandardRequestFactories;
import com.goodbird.mindofthecolony.mc.core.colony.requestsystem.resolvers.factory.*;
import com.goodbird.mindofthecolony.mc.core.research.GlobalResearchFactory;
import com.goodbird.mindofthecolony.mc.core.research.LocalResearchFactory;
