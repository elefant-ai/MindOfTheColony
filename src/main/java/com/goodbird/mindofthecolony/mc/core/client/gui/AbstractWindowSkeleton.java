...
import com.goodbird.mindofthecolony.mc.api.colony.modules.IModuleContainer;
import com.goodbird.mindofthecolony.mc.core.client.gui.modules.IWindowModule;
import com.goodbird.mindofthecolony.mc.core.client.gui.modules.IWindowWithLayoutModule;
import com.goodbird.mindofthecolony.mc.core.network.messages.server.ClickGuiButtonTriggerMessage;
import com.goodbird.mindofthecolony.mc.core.network.messages.server.OpenGuiWindowTriggerMessage;
...
public abstract class AbstractWindowSkeleton extends BOWindow implements ButtonHandler, IModuleContainer<IWindowModule>
{
    ...
    public AbstractWindowSkeleton(@Nullable final BOWindow parent, final ResourceLocation resource)
    {
        ...
        if (switchView != null)
        {
            ...
            PaneBuilders.singleLineTooltip(Component.translatableEscape("com.goodbird.mindofthecolony.mc.core.gui.nextpage"), buttonNextPage);
            PaneBuilders.singleLineTooltip(Component.translatableEscape("com.goodbird.mindofthecolony.mc.core.gui.prevpage"), buttonPrevPage);
