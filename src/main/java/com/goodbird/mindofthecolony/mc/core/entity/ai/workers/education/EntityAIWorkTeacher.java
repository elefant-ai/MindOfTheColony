...
import com.goodbird.mindofthecolony.mc.core.colony.jobs.JobTeacher;
...
import static com.goodbird.mindofthecolony.mc.api.util.constant.StatisticsConstants.LESSONS_GIVEN;
...
public class EntityAIWorkTeacher extends AbstractEntityAIInteract<JobTeacher, BuildingSchool>
{
    ...
    private final static VisibleCitizenStatus TEACHING_ICON =
      new VisibleCitizenStatus(new ResourceLocation(Constants.MOD_ID, "textures/icons/work/teacher_student.png"), "com.goodbird.mindofthecolony.mc.gui.visiblestatus.teacher_student");
