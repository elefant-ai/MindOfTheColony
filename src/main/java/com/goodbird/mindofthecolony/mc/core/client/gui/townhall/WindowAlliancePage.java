...
import com.goodbird.mindofthecolony.mc.api.colony.connections.*;
...
import com.goodbird.mindofthecolony.mc.core.network.messages.server.colony.TriggerConnectionEventMessage;
        ...
        connectionScrollList.setDataProvider(new ScrollingList.DataProvider()
        {
            ...
            public void updateElement(final int index, @NotNull final Pane rowPane)
            {
                ...
                rowPane.findPaneOfTypeByID("distance", Text.class)
                    .setText(Component.translatable("com.goodbird.mindofthecolony.mc.coremod.dist.blocks", (int) BlockPosUtil.dist(colonyData.pos, buildingView.getColony().getCenter())));
