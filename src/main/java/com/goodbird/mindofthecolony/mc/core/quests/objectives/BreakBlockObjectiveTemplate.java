...
public class BreakBlockObjectiveTemplate extends DialogueObjectiveTemplateTemplate implements IBreakBlockObjectiveTemplate
{
    ...
    {
        final Component text = Component.translatableEscape("com.goodbird.mindofthecolony.mc.coremod.questobjectives.breakblock", blockToMine.getName());
    ...
    public Component getProgressText(final IQuestInstance quest, final Style style)
    {
        ...
        {
            return Component.translatableEscape("com.goodbird.mindofthecolony.mc.coremod.questobjectives.breakblock.progress",
