...
import com.goodbird.mindofthecolony.mc.core.colony.buildings.modules.settings.GuardTaskSetting;
import com.goodbird.mindofthecolony.mc.core.colony.jobs.AbstractJobGuard;
import com.goodbird.mindofthecolony.mc.core.entity.ai.combat.AttackMoveAI;
import com.goodbird.mindofthecolony.mc.core.entity.ai.combat.CombatUtils;
import com.goodbird.mindofthecolony.mc.core.entity.citizen.EntityCitizen;
import com.goodbird.mindofthecolony.mc.core.entity.other.CustomArrowEntity;
import com.goodbird.mindofthecolony.mc.core.entity.pathfinding.PathfindingUtils;
import com.goodbird.mindofthecolony.mc.core.entity.pathfinding.PathingOptions;
...
import com.goodbird.mindofthecolony.mc.core.entity.pathfinding.pathjobs.PathJobCanSee;
import com.goodbird.mindofthecolony.mc.core.entity.pathfinding.pathjobs.PathJobMoveAwayFromLocation;
import com.goodbird.mindofthecolony.mc.core.entity.pathfinding.pathjobs.PathJobMoveToLocation;
...
import static com.goodbird.mindofthecolony.mc.api.util.constant.StatisticsConstants.MOBS_KILLED;
import static com.goodbird.mindofthecolony.mc.api.util.constant.StatisticsConstants.MOB_KILLED;
import static com.goodbird.mindofthecolony.mc.core.colony.buildings.modules.BuildingModules.STATS_MODULE;
import static com.goodbird.mindofthecolony.mc.core.entity.ai.BehaviourStateGroup.GUARD_ABORT_AND_FIGHT;
import static com.goodbird.mindofthecolony.mc.core.entity.ai.workers.guard.AbstractEntityAIFight.SPEED_LEVEL_BONUS;
import static com.goodbird.mindofthecolony.mc.core.entity.ai.workers.guard.AbstractEntityAIGuard.PATROL_DEVIATION_RAID_POINT;
...
public class RangerCombatAI extends AttackMoveAI<EntityCitizen>
{
    ...
    private final static VisibleCitizenStatus ARCHER_COMBAT =
      new VisibleCitizenStatus(new ResourceLocation(Constants.MOD_ID, "textures/icons/work/archer_combat.png"), "com.goodbird.mindofthecolony.mc.gui.visiblestatus.archer_combat");
