...
public class DefaultAlchemistCraftingProvider extends CustomRecipeProvider
{
    ...
    protected void registerRecipes(@NotNull Consumer<CustomRecipeBuilder> consumer)
    {
        ...
        suspiciousPotion.set(DataComponents.ITEM_NAME, Component.translatable("com.goodbird.mindofthecolony.mc.alchemyquestpotion.name"));
        suspiciousPotion.set(DataComponents.LORE, new ItemLore(List.of(Component.translatable("com.goodbird.mindofthecolony.mc.alchemyquestpotion.lore"))));
