...
public class DeliveryObjectiveTemplateTemplate extends DialogueObjectiveTemplateTemplate implements IQuestDeliveryObjective
{
    ...
    {
        final Component ready = Component.translatableEscape("com.goodbird.mindofthecolony.mc.coremod.questobjectives.delivery.ready", item.getDisplayName());
        final AnswerElement ready1 = new AnswerElement(Component.translatableEscape("com.goodbird.mindofthecolony.mc.coremod.questobjectives.delivery.ready.give"),
                new IQuestDialogueAnswer.NextObjectiveDialogueAnswer(this.nextObjective));
        final AnswerElement ready2 = new AnswerElement(Component.translatableEscape("com.goodbird.mindofthecolony.mc.coremod.questobjectives.delivery.ready.later"),
                new IQuestDialogueAnswer.CloseUIDialogueAnswer());
        this.readyDialogueElement = new DialogueElement(ready, List.of(ready1, ready2));

        final Component waiting = Component.translatableEscape("com.goodbird.mindofthecolony.mc.coremod.questobjectives.delivery.waiting", item.getDisplayName());
        final AnswerElement waiting1 = new AnswerElement(Component.translatableEscape("com.goodbird.mindofthecolony.mc.coremod.questobjectives.answer.later"),
                new IQuestDialogueAnswer.CloseUIDialogueAnswer());
        final AnswerElement waiting2 = new AnswerElement(Component.translatableEscape("com.goodbird.mindofthecolony.mc.coremod.questobjectives.delivery.waiting.cancel"),
    ...
    {
        return Component.translatableEscape("com.goodbird.mindofthecolony.mc.coremod.questobjectives.delivery.progress",
          0,
          quantity,
