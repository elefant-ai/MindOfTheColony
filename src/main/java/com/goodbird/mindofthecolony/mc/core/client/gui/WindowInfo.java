...
import static com.goodbird.mindofthecolony.mc.api.util.constant.TranslationConstants.PARTIAL_INFO_TEXT;
import static com.goodbird.mindofthecolony.mc.api.util.constant.WindowConstants.BUTTON_EXIT;
...
public class WindowInfo extends AbstractWindowSkeleton
{
    ...
    public WindowInfo(final IBuildingView building)
    {
        ...
        final String translationPrefix = PARTIAL_INFO_TEXT + building.getBuildingType().getTranslationKey().replace("com.goodbird.mindofthecolony.mc.building.", "") + ".";
