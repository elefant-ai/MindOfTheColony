package com.goodbird.mindofthecolony.mc.core;
...
import com.goodbird.mindofthecolony.mc.api.advancements.AdvancementTriggers;
...
import com.goodbird.mindofthecolony.mc.api.creativetab.ModCreativeTabs;
...
import com.goodbird.mindofthecolony.mc.api.entity.mobs.RaiderMobUtils;
...
import com.goodbird.mindofthecolony.mc.api.items.ModTags;
import com.goodbird.mindofthecolony.mc.api.items.component.ModDataComponents;
import com.goodbird.mindofthecolony.mc.api.loot.ModLootConditions;
import com.goodbird.mindofthecolony.mc.api.sounds.ModSoundEvents;
import com.goodbird.mindofthecolony.mc.api.tileentities.MinecoloniesTileEntities;
import com.goodbird.mindofthecolony.mc.api.util.IItemHandlerCapProvider;
import com.goodbird.mindofthecolony.mc.api.util.Log;
import com.goodbird.mindofthecolony.mc.api.util.constant.Constants;
import com.goodbird.mindofthecolony.mc.api.util.constant.SchematicTagConstants;
import com.goodbird.mindofthecolony.mc.apiimp.ClientMinecoloniesAPIImpl;
import com.goodbird.mindofthecolony.mc.apiimp.CommonMinecoloniesAPIImpl;
import com.goodbird.mindofthecolony.mc.apiimp.initializer.*;
import com.goodbird.mindofthecolony.mc.core.blocks.BlockPlantationField;
import com.goodbird.mindofthecolony.mc.core.blocks.huts.BlockHutGateHouse;
import com.goodbird.mindofthecolony.mc.core.client.render.SpearItemTileEntityRenderer;
import com.goodbird.mindofthecolony.mc.core.colony.crafting.CustomRecipeManagerMessage;
import com.goodbird.mindofthecolony.mc.core.colony.requestsystem.init.RequestSystemInitializer;
import com.goodbird.mindofthecolony.mc.core.colony.requestsystem.init.StandardFactoryControllerInitializer;
import com.goodbird.mindofthecolony.mc.core.commands.arguments.ModArgumentTypes;
import com.goodbird.mindofthecolony.mc.core.debug.messages.DebugEnableMessage;
import com.goodbird.mindofthecolony.mc.core.debug.messages.DebugEnablePathfindingMessage;
import com.goodbird.mindofthecolony.mc.core.debug.messages.DebugOutputMessage;
import com.goodbird.mindofthecolony.mc.core.debug.messages.QueryCitizenAIHistoryMessage;
import com.goodbird.mindofthecolony.mc.core.entity.mobs.EntityMercenary;
import com.goodbird.mindofthecolony.mc.core.event.*;
import com.goodbird.mindofthecolony.mc.core.network.messages.PermissionsMessage;
import com.goodbird.mindofthecolony.mc.core.network.messages.client.*;
import com.goodbird.mindofthecolony.mc.core.network.messages.client.colony.*;
import com.goodbird.mindofthecolony.mc.core.network.messages.server.*;
import com.goodbird.mindofthecolony.mc.core.network.messages.server.colony.*;
import com.goodbird.mindofthecolony.mc.core.network.messages.server.colony.building.*;
import com.goodbird.mindofthecolony.mc.core.network.messages.server.colony.building.builder.BuilderSelectWorkOrderMessage;
import com.goodbird.mindofthecolony.mc.core.network.messages.server.colony.building.enchanter.EnchanterWorkerSetMessage;
import com.goodbird.mindofthecolony.mc.core.network.messages.server.colony.building.fields.AssignFieldMessage;
import com.goodbird.mindofthecolony.mc.core.network.messages.server.colony.building.fields.AssignmentModeMessage;
import com.goodbird.mindofthecolony.mc.core.network.messages.server.colony.building.fields.FarmFieldPlotResizeMessage;
import com.goodbird.mindofthecolony.mc.core.network.messages.server.colony.building.fields.FarmFieldUpdateSeedMessage;
import com.goodbird.mindofthecolony.mc.core.network.messages.server.colony.building.guard.GuardSetMinePosMessage;
import com.goodbird.mindofthecolony.mc.core.network.messages.server.colony.building.home.AssignUnassignMessage;
import com.goodbird.mindofthecolony.mc.core.network.messages.server.colony.building.miner.MinerRepairLevelMessage;
import com.goodbird.mindofthecolony.mc.core.network.messages.server.colony.building.miner.MinerSetLevelMessage;
import com.goodbird.mindofthecolony.mc.core.network.messages.server.colony.building.postbox.PostBoxRequestMessage;
import com.goodbird.mindofthecolony.mc.core.network.messages.server.colony.building.university.TryResearchMessage;
import com.goodbird.mindofthecolony.mc.core.network.messages.server.colony.building.warehouse.SortBuildingMessage;
import com.goodbird.mindofthecolony.mc.core.network.messages.server.colony.building.warehouse.UpgradeWarehouseMessage;
import com.goodbird.mindofthecolony.mc.core.network.messages.server.colony.building.worker.*;
import com.goodbird.mindofthecolony.mc.core.network.messages.server.colony.citizen.*;
import com.goodbird.mindofthecolony.mc.core.placementhandlers.PlacementHandlerInitializer;
import com.goodbird.mindofthecolony.mc.core.placementhandlers.main.SuppliesHandler;
import com.goodbird.mindofthecolony.mc.core.placementhandlers.main.SurvivalHandler;
import com.goodbird.mindofthecolony.mc.core.research.GlobalResearchTreeMessage;
import com.goodbird.mindofthecolony.mc.core.structures.MineColoniesStructures;
...
import static com.goodbird.mindofthecolony.mc.api.util.constant.SchematicTagConstants.*;

// @Mod annotation removed — this is the fork copy, not the mod entrypoint
