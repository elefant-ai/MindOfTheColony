...
import com.goodbird.mindofthecolony.mc.core.client.gui.modules.building.WorkOrderModuleWindow;
...
public class WorkOrderListModuleView extends AbstractBuildingModuleView
{
    ...
    {
        return Component.translatable("com.goodbird.mindofthecolony.mc.coremod.gui.townhall.workorders");
    }
