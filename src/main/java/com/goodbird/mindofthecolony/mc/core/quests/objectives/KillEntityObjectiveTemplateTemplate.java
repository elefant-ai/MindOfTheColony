...
public class KillEntityObjectiveTemplateTemplate extends DialogueObjectiveTemplateTemplate implements IKillEntityObjectiveTemplate
{
    ...
    {
        final Component text = Component.translatableEscape("com.goodbird.mindofthecolony.mc.coremod.questobjectives.kill", entityToKill.getDescription());
    ...
    public Component getProgressText(final IQuestInstance quest, final Style style)
    {
        ...
        {
            return Component.translatableEscape("com.goodbird.mindofthecolony.mc.coremod.questobjectives.kill.progress",
