...
import static com.goodbird.mindofthecolony.mc.api.util.constant.WindowConstants.LIST_SETTINGS;
        ...
        settingsList.setDataProvider(new ScrollingList.DataProvider()
        {
            ...
            public void updateElement(final int index, @NotNull final Pane rowPane)
            {
                ...
                if (box.getChildren().isEmpty())
                {
                    ...
                    {
                        rowDescriptionField.setText(Component.translatableEscape("com.goodbird.mindofthecolony.mc.coremod.setting." + key.getUniqueId().toString()));
                    }
                }
