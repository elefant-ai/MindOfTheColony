...
import com.goodbird.mindofthecolony.mc.core.commands.arguments.MultiColonyIdArgument;
import com.goodbird.mindofthecolony.mc.core.commands.arguments.MultipleOptionsArgument;
...
import static com.goodbird.mindofthecolony.mc.core.commands.CommandArgumentNames.*;
...
public class CommandRaid implements IMCOPCommand
{
    private static final DynamicCommandExceptionType ERROR_INVALID_COLONY_EVENT_TYPE =
        new DynamicCommandExceptionType(entry -> Component.translatableEscape("com.goodbird.mindofthecolony.mc.command.raid.colony_type.invalid", entry));
