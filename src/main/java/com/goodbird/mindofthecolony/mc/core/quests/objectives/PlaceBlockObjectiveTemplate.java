...
public class PlaceBlockObjectiveTemplate extends DialogueObjectiveTemplateTemplate implements IPlaceBlockObjectiveTemplate
{
    ...
    {
        final Component text = Component.translatableEscape("com.goodbird.mindofthecolony.mc.coremod.questobjectives.placeblock", blockToMine.getName());
    ...
    public Component getProgressText(final IQuestInstance quest, final Style style)
    {
        ...
        {
            return Component.translatableEscape("com.goodbird.mindofthecolony.mc.coremod.questobjectives.placeblock.progress",
