...
public class FamilyWindowCitizen extends AbstractWindowCitizen
{
    ...
    public void onOpened()
    {
        ...
        findPaneOfTypeByID("parentA", Text.class).setText(firstParent.isEmpty() ? Component.translatableEscape("com.goodbird.mindofthecolony.mc.coremod.gui.citizen.family.unknown") : Component.literal(firstParent));
        findPaneOfTypeByID("parentB", Text.class).setText(secondParent.isEmpty() ? Component.translatableEscape("com.goodbird.mindofthecolony.mc.coremod.gui.citizen.family.unknown") : Component.literal(secondParent));
