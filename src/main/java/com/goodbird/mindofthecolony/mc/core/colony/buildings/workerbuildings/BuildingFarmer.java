...
import com.goodbird.mindofthecolony.mc.api.crafting.GenericRecipe;
import com.goodbird.mindofthecolony.mc.api.crafting.IGenericRecipe;
...
import com.goodbird.mindofthecolony.mc.api.util.CraftingUtils;
import com.goodbird.mindofthecolony.mc.api.util.ItemStackUtils;
import com.goodbird.mindofthecolony.mc.api.util.OptionalPredicate;
import com.goodbird.mindofthecolony.mc.core.blocks.MinecoloniesCropBlock;
import com.goodbird.mindofthecolony.mc.core.client.gui.modules.building.FarmFieldsModuleWindow;
...
import com.goodbird.mindofthecolony.mc.core.colony.buildings.moduleviews.FieldsModuleView;
...
import static com.goodbird.mindofthecolony.mc.api.util.constant.TagConstants.CRAFTING_FARMER;
import static com.goodbird.mindofthecolony.mc.api.util.constant.TranslationConstants.PARTIAL_JEI_INFO;
import static com.goodbird.mindofthecolony.mc.api.util.constant.translation.GuiTranslationConstants.FIELD_LIST_FARMER_NO_SEED;
...
public class BuildingFarmer extends AbstractBuilding
{
    ...
    public static final ISettingKey<BoolSetting> FERTILIZE =
      new SettingKey<>(BoolSetting.class, new ResourceLocation(com.goodbird.mindofthecolony.mc.api.util.constant.Constants.MOD_ID, "fertilize"));
