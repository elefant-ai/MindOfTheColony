...
public class KnightCombatAI extends AttackMoveAI<EntityCitizen>
{
    ...
    private final static VisibleCitizenStatus KNIGHT_COMBAT =
      new VisibleCitizenStatus(new ResourceLocation(Constants.MOD_ID, "textures/icons/work/knight_combat.png"), "com.goodbird.mindofthecolony.mc.gui.visiblestatus.knight_combat");
