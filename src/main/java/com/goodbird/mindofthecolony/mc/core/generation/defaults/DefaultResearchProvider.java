...
import com.goodbird.mindofthecolony.mc.api.research.AbstractResearchProvider;
import com.goodbird.mindofthecolony.mc.api.research.ResearchBranchType;
...
public class DefaultResearchProvider extends AbstractResearchProvider
{
     ...
     * Only use setBranchType for non-default styled branches, and use {@link com.goodbird.mindofthecolony.mc.api.research.ResearchBranchType} to do so.
     *
     ...
     * Unlock-building effect ids are automatically generated from hut block ids; all other effect IDs should use {@link com.goodbird.mindofthecolony.mc.api.research.util.ResearchConstants}
     *
