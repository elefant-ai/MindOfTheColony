...
import com.goodbird.mindofthecolony.mc.core.client.gui.modules.building.WindowListRecipes;
import com.goodbird.mindofthecolony.mc.core.colony.buildings.views.AbstractBuildingView;
import com.goodbird.mindofthecolony.mc.core.network.messages.server.colony.building.OpenCraftingGUIMessage;
...
public class CraftingModuleView extends AbstractBuildingModuleView
{
    ...
    {
        return Component.translatable("com.goodbird.mindofthecolony.mc.coremod.gui.workerhuts.recipe." + id);
    }
