...
import com.goodbird.mindofthecolony.mc.core.colony.buildings.workerbuildings.BuildingCrusher;
import com.goodbird.mindofthecolony.mc.core.colony.jobs.JobCrusher;
...
public class EntityAIWorkCrusher extends AbstractEntityAICrafting<JobCrusher, BuildingCrusher>
{
    ...
    private final static VisibleCitizenStatus CRUSHING =
      new VisibleCitizenStatus(new ResourceLocation(Constants.MOD_ID, "textures/icons/work/crusher.png"), "com.goodbird.mindofthecolony.mc.gui.visiblestatus.crusher");
