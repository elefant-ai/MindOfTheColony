...
import com.goodbird.mindofthecolony.mc.core.client.gui.townhall.AbstractWindowTownHall;
...
public class WindowBannerPicker extends Screen
{
    ...
    protected void createPatternButtons()
    {
        for (int i = 0; i < patterns.size(); i++)
        {
            ...
            {
                button.setTooltip(Tooltip.create(Component.translatable("com.goodbird.mindofthecolony.mc.core.gui.banner.patreon")));
                button.blocked = true;
            }
        }
    }
    ...
    public void render(final GuiGraphics stack, int mouseX, int mouseY, float partialTicks)
    {
        ...
        stack.drawCenteredString(this.font,
                Component.translatableEscape("com.goodbird.mindofthecolony.mc.coremod.gui.flag.choose").getString(),
                this.width /2,
                16,
                0xFFFFFF /* white */
        );
    ...
    public class LayerButton extends Button
    {
        ...
        public LayerButton(int x, int y, int width, int height, int layer)
        {
            super(
                    ...
                    layer == 0
                            ? Component.translatableEscape("com.goodbird.mindofthecolony.mc.coremod.gui.flag.base_layer")
