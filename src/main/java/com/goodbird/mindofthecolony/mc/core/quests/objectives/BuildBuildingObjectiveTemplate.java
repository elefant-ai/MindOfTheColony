...
import com.goodbird.mindofthecolony.mc.api.quests.IQuestDialogueAnswer;
import com.goodbird.mindofthecolony.mc.api.quests.IQuestInstance;
import com.goodbird.mindofthecolony.mc.api.quests.IQuestObjectiveTemplate;
...
import static com.goodbird.mindofthecolony.mc.api.util.constant.NbtTagConstants.TAG_QUANTITY;
...
public class BuildBuildingObjectiveTemplate extends DialogueObjectiveTemplateTemplate implements IBuildingUpgradeObjectiveTemplate
{
    ...
    private static DialogueElement buildDialogueTree(final BuildingEntry buildingEntry, final int qty, final int lvl, final boolean countExisting)
    {
        ...
        if (countExisting)
        {
            ...
            {
                text =
                  Component.translatableEscape("com.goodbird.mindofthecolony.mc.coremod.questobjectives.buildbuilding.existing", lvl, qty, Component.translatableEscape(buildingEntry.getTranslationKey()));
            }
            else
            {
                text = Component.translatableEscape("com.goodbird.mindofthecolony.mc.coremod.questobjectives.buildbuilding.cumulative.existing",
                  lvl,
        ...
        else
        {
            if (qty > 0)
            {
                text = Component.translatableEscape("com.goodbird.mindofthecolony.mc.coremod.questobjectives.buildbuilding", qty, lvl, Component.translatableEscape(buildingEntry.getTranslationKey()));
            }
            else
            {
                text = Component.translatableEscape("com.goodbird.mindofthecolony.mc.coremod.questobjectives.buildbuilding.cumulative", lvl, Component.translatableEscape(buildingEntry.getTranslationKey()));
            }
        }

        final AnswerElement answer1 = new AnswerElement(Component.translatableEscape("com.goodbird.mindofthecolony.mc.coremod.questobjectives.answer.later"),
          new IQuestDialogueAnswer.CloseUIDialogueAnswer());
        final AnswerElement answer2 = new AnswerElement(Component.translatableEscape("com.goodbird.mindofthecolony.mc.coremod.questobjectives.answer.cancel"),
    ...
    public Component getProgressText(final IQuestInstance quest, final Style style)
    {
        if (quest.getCurrentObjectiveInstance() instanceof BuildingProgressInstance progress)
        {
            if (qty > 0)
            {
                return Component.translatableEscape("com.goodbird.mindofthecolony.mc.coremod.questobjectives.buildbuilding.progress",
            ...
            {
                return Component.translatableEscape("com.goodbird.mindofthecolony.mc.coremod.questobjectives.buildbuilding.progress.cumulative",
