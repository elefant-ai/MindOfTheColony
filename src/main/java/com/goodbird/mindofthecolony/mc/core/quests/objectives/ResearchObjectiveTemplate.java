...
public class ResearchObjectiveTemplate extends DialogueObjectiveTemplateTemplate implements IResearchObjectiveTemplate
{
    ...
    private static DialogueElement buildDialogueTree(final ResourceLocation researchId)
    {
        ...
        final Component text  = Component.translatable("com.goodbird.mindofthecolony.mc.coremod.questobjectives.research", MutableComponent.create((research.getName())));

        final AnswerElement answer1 = new AnswerElement(Component.translatable("com.goodbird.mindofthecolony.mc.coremod.questobjectives.answer.later"),
          new IQuestDialogueAnswer.CloseUIDialogueAnswer());
        final AnswerElement answer2 = new AnswerElement(Component.translatable("com.goodbird.mindofthecolony.mc.coremod.questobjectives.answer.cancel"),
    ...
    public Component getProgressText(final IQuestInstance quest, final Style style)
    {
        ...
        return Component.translatable("com.goodbird.mindofthecolony.mc.coremod.questobjectives.research.progress", MutableComponent.create(research.getName()));
    }
