...
import com.goodbird.mindofthecolony.mc.core.colony.buildings.moduleviews.SettingsModuleView;
import com.goodbird.mindofthecolony.mc.core.colony.buildings.moduleviews.WorkOrderListModuleView;
import com.goodbird.mindofthecolony.mc.core.colony.buildings.workerbuildings.BuildingBuilder;
import com.goodbird.mindofthecolony.mc.core.network.messages.server.colony.WorkOrderChangeMessage;
...
public class WorkOrderModuleWindow extends AbstractModuleWindow<WorkOrderListModuleView>
{
    ...
    private void updateAvailableWorkOrders(final int index, @NotNull final Pane rowPane)
    {
        ...
        rowPane.findPaneOfTypeByID(WORK_ORDER_POS, Text.class)
          .setText(Component.translatableEscape("com.goodbird.mindofthecolony.mc.coremod.gui.blocks.distance", BlockPosUtil.getDistance2D(order.getLocation(), buildingView.getPosition())));
        ...
        {
            rowPane.findPaneOfTypeByID(WORK_ORDER_SELECT, ButtonImage.class).setText(Component.translatableEscape("com.goodbird.mindofthecolony.mc.coremod.gui.builder.cancel"));
        }
        else if (manualMode)
        {
            Button assign = rowPane.findPaneOfTypeByID(WORK_ORDER_SELECT, ButtonImage.class);
            assign.setText(Component.translatable("com.goodbird.mindofthecolony.mc.coremod.gui.builder.select"));
