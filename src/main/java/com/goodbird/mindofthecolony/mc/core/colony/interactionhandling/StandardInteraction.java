...
public class StandardInteraction extends ServerCitizenInteraction
{
     ...
     * Standard responses
     */
    public static final String INTERACTION_R_OKAY   = "com.goodbird.mindofthecolony.mc.coremod.gui.chat.okay";
    public static final String INTERACTION_R_IGNORE = "com.goodbird.mindofthecolony.mc.coremod.gui.chat.ignore";
    public static final String INTERACTION_R_REMIND = "com.goodbird.mindofthecolony.mc.coremod.gui.chat.remindmelater";
    public static final String INTERACTION_R_SKIP   = "com.goodbird.mindofthecolony.mc.coremod.gui.chat.skipchitchat";
