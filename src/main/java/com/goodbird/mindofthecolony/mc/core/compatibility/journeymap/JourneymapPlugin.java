package com.goodbird.mindofthecolony.mc.core.compatibility.journeymap;
...
import static com.goodbird.mindofthecolony.mc.api.entity.citizen.AbstractEntityCitizen.DATA_JOB;
import static com.goodbird.mindofthecolony.mc.api.util.constant.Constants.MOD_ID;
import static com.goodbird.mindofthecolony.mc.api.util.constant.TranslationConstants.PARTIAL_JOURNEY_MAP_INFO;
...
public class JourneymapPlugin implements IClientPlugin
{
    ...
    {
        event.register(MOD_ID, "com.goodbird.mindofthecolony.mc.coremod.journeymap.currentcolony", 2500, ColonyBorderMapping::getCurrentColony);
    }
