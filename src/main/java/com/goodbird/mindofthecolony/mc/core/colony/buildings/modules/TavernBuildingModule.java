...
import com.goodbird.mindofthecolony.mc.api.colony.buildings.modules.stat.IStat;
import com.goodbird.mindofthecolony.mc.api.colony.interactionhandling.ChatPriority;
import com.goodbird.mindofthecolony.mc.api.sounds.TavernSounds;
...
import com.goodbird.mindofthecolony.mc.core.client.gui.huts.WindowHutLiving;
...
import com.goodbird.mindofthecolony.mc.core.datalistener.CustomVisitorListener;
import com.goodbird.mindofthecolony.mc.core.datalistener.RecruitmentItemsListener;
import com.goodbird.mindofthecolony.mc.core.network.messages.client.colony.PlayMusicAtPosMessage;
...
import static com.goodbird.mindofthecolony.mc.api.util.constant.Constants.MAX_STORY;
import static com.goodbird.mindofthecolony.mc.api.util.constant.Constants.TAG_COMPOUND;
import static com.goodbird.mindofthecolony.mc.api.util.constant.NbtTagConstants.*;
import static com.goodbird.mindofthecolony.mc.api.util.constant.NbtTagConstants.TAG_WORK;
import static com.goodbird.mindofthecolony.mc.api.util.constant.SchematicTagConstants.*;
import static com.goodbird.mindofthecolony.mc.api.util.constant.StatisticsConstants.NEW_VISITORS;
/**
    ...
    private void spawnVisitorInternal()
    {
        ...
        if (visitorData != null && !CustomVisitorListener.chanceCustomVisitors(visitorData))
        {
            visitorData.triggerInteraction(new RecruitmentInteraction(Component.translatable(
                "com.goodbird.mindofthecolony.mc.coremod.gui.chat.recruitstory" + (building.getColony().getWorld().random.nextInt(MAX_STORY) + 1), visitorData.getName().split(" ")[0]),
