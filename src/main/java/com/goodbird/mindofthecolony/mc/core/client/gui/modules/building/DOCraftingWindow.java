...
import com.goodbird.mindofthecolony.mc.core.colony.buildings.moduleviews.DOCraftingModuleView;
...
import static com.goodbird.mindofthecolony.mc.api.util.constant.TranslationConstants.DOCRAFTING_BLOCK;
...
public class DOCraftingWindow extends AbstractModuleWindow<DOCraftingModuleView>
{
    ...
    private void addRecipe()
    {
        ...
        final IRecipeStorage storage = RecipeStorage.builder()
                ...
                .withGridSize(3)
                .withRecipeType(com.goodbird.mindofthecolony.mc.api.crafting.ModRecipeTypes.MULTI_OUTPUT_ID)
                .build();
