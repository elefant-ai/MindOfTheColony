...
import com.goodbird.mindofthecolony.mc.api.research.IResearchRequirement;
...
import com.goodbird.mindofthecolony.mc.core.client.gui.WindowResearchTree;
import com.goodbird.mindofthecolony.mc.core.colony.buildings.moduleviews.UniversityResearchModuleView;
...
import static com.goodbird.mindofthecolony.mc.api.research.util.ResearchConstants.COLOR_TEXT_UNFULFILLED;
import static com.goodbird.mindofthecolony.mc.api.util.constant.WindowConstants.GUI_LIST_ELEMENT_NAME;
import static com.goodbird.mindofthecolony.mc.api.util.constant.WindowConstants.UNI_INV_RESEARCH;
/**
...
public class UniversityModuleWindow extends AbstractModuleWindow<UniversityResearchModuleView>
{
    ...
    public List<MutableComponent> getHidingRequirementDesc(final ResourceLocation branch)
    {
        ...
        for(final ResourceLocation primary : IGlobalResearchTree.getInstance().getPrimaryResearch(branch))
        {
            ...
            else
            {
                ...
                {
                    requirements.add(Component.translatableEscape("com.goodbird.mindofthecolony.mc.coremod.research.locked"));
                }
                else
                {
    ...
    public void updateResearchCount(final int offset)
    {
        this.findPaneOfTypeByID("maxresearchwarn", Text.class)
          .setText(Component.translatableEscape("com.goodbird.mindofthecolony.mc.coremod.gui.research.countinprogress",
