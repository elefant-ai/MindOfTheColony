...
import com.goodbird.mindofthecolony.mc.api.colony.buildings.modules.IAssignmentModuleView;
...
import com.goodbird.mindofthecolony.mc.core.colony.CitizenDataView;
import com.goodbird.mindofthecolony.mc.core.colony.buildings.moduleviews.PupilBuildingModuleView;
...
import com.goodbird.mindofthecolony.mc.core.network.messages.server.colony.citizen.PauseCitizenMessage;
import com.goodbird.mindofthecolony.mc.core.network.messages.server.colony.citizen.RestartCitizenMessage;
...
import static com.goodbird.mindofthecolony.mc.core.client.gui.modules.building.WindowBuilderResModule.BLACK;
...
public class WindowHireWorker extends AbstractWindowSkeleton
{
    ...
    private void setupDescription(boolean isDedicated)
    {
        ...
        if (isDedicated)
        {
            ...
            description = Component.translatableEscape("com.goodbird.mindofthecolony.mc.coremod.gui.hiring.dedicated", jobs, description);
        }

        findPaneOfTypeByID(JOB_TITLE_LABEL, Text.class).setText(Component.translatableEscape("com.goodbird.mindofthecolony.mc.coremod.gui.hiring.description", description));
    }
        ...
        citizenList.setDataProvider(new ScrollingList.DataProvider()
        {
            ...
            public void updateElement(final int index, @NotNull final Pane rowPane)
            {
                ...
                for (final Map.Entry<Skill, CitizenSkillHandler.SkillData> entry : skills)
                {
                    ...
                    textBuilder.append(Component.translatableEscape("com.goodbird.mindofthecolony.mc.coremod.gui.citizen.skills." + skillName).setStyle(skillStyle));
                ...
                {
                    rowPane.findPaneOfTypeByID(DISTANCE_LABEL, Text.class).setText(Component.translatableEscape("com.goodbird.mindofthecolony.mc.core.gui.hiring.homeless"));
                }
                else if (citizen.getHomeBuilding().equals(building.getPosition()))
                {
                    rowPane.findPaneOfTypeByID(DISTANCE_LABEL, Text.class).setText(Component.translatableEscape("com.goodbird.mindofthecolony.mc.core.gui.hiring.liveshere"));
                }
                else if (citizen.getHomeBuilding().equals(citizen.getWorkBuilding()))
                {
                    rowPane.findPaneOfTypeByID(DISTANCE_LABEL, Text.class).setText(Component.translatableEscape("com.goodbird.mindofthecolony.mc.core.gui.hiring.livesatwork"));
                }
                else
                {
                    rowPane.findPaneOfTypeByID(DISTANCE_LABEL, Text.class)
                      .setText(Component.translatableEscape("com.goodbird.mindofthecolony.mc.core.gui.hiring.distance", (int) Math.sqrt(citizen.getHomeBuilding().distSqr(building.getPosition()))));
                }
