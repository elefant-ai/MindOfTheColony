package com.goodbird.mindofthecolony.mc.core.client.gui.containers;
...
import com.goodbird.mindofthecolony.mc.core.tileentities.TileEntityScarecrow;
...
import static com.goodbird.mindofthecolony.mc.api.items.ModTags.cropBiomeTags;
import static com.goodbird.mindofthecolony.mc.api.util.constant.TranslationConstants.*;
import static com.goodbird.mindofthecolony.mc.api.util.constant.translation.GuiTranslationConstants.FIELD_GUI_ASSIGNED_FARMER;
import static com.goodbird.mindofthecolony.mc.api.util.constant.translation.GuiTranslationConstants.FIELD_GUI_NO_ASSIGNED_FARMER;
import static com.goodbird.mindofthecolony.mc.core.colony.buildingextensions.FarmField.MAX_RANGE;
...
public class WindowField extends AbstractWindowSkeleton
{
    ...
    public WindowField(@NotNull TileEntityScarecrow tileEntityScarecrow)
    {
        ...
        this.findPaneOfTypeByID("biome", Text.class)
            .setText(Component.translatable("com.goodbird.mindofthecolony.mc.core.biome")
    ...
    private void selectSeed()
    {
        ...
        new WindowSelectRes(
            this,
            Component.translatable("com.goodbird.mindofthecolony.mc.coremod.gui.field.selectseed"),
            farmField.getSeed(),
