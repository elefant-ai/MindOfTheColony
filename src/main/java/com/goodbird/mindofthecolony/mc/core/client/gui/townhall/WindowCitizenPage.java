...
import com.goodbird.mindofthecolony.mc.core.network.messages.server.colony.citizen.RecallSingleCitizenMessage;
...
import static com.goodbird.mindofthecolony.mc.api.util.constant.TranslationConstants.PARTIAL_HAPPINESS_MODIFIER_NAME;
...
public class WindowCitizenPage extends AbstractWindowTownHall
{
        ...
        citizenList.setDataProvider(new ScrollingList.DataProvider()
        {
            ...
            public void updateElement(final int index, @NotNull final Pane rowPane)
            {
                ...
                for (final Map.Entry<Skill, CitizenSkillHandler.SkillData> entry : citizen.getCitizenSkillHandler().getSkills().entrySet())
                {
                    ...
                    textBuilder.append(Component.translatableEscape("com.goodbird.mindofthecolony.mc.coremod.gui.citizen.skills." + skillName));
    ...
    private void fillHappinessList()
    {
        ...
        findPaneOfTypeByID("happinessTitle", Text.class).setText(Component.translatableEscape("com.goodbird.mindofthecolony.mc.coremod.gui.townhall.currenthappiness", roundedHappiness));
        ...
        happinessScrollingList.setDataProvider(new ScrollingList.DataProvider()
        {
            ...
            public void updateElement(final int index, @NotNull final Pane rowPane)
            {
                ...
                PaneBuilders.tooltipBuilder().hoverPane(label).append(Component.translatableEscape("com.goodbird.mindofthecolony.mc.coremod.gui.townhall.happiness.desc." + entry.getKey())).build();
            }
        });
    }
