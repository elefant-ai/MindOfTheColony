...
import com.goodbird.mindofthecolony.mc.api.util.LoadOnlyStructureHandler;
...
import com.goodbird.mindofthecolony.mc.core.network.messages.server.colony.building.BuildPickUpMessage;
import com.goodbird.mindofthecolony.mc.core.network.messages.server.colony.building.BuildRequestMessage;
import com.goodbird.mindofthecolony.mc.core.network.messages.server.colony.building.BuildingSetStyleMessage;
...
import static com.goodbird.mindofthecolony.mc.api.util.constant.TranslationConstants.ACTION_BUILD;
import static com.goodbird.mindofthecolony.mc.api.util.constant.TranslationConstants.ACTION_UPGRADE;
...
public class WindowBuildBuilding extends AbstractWindowSkeleton
{
    ...
    public WindowBuildBuilding(final IColonyView c, final IBuildingView building)
    {
        ...
        {
            buttonBuild.setText(Component.translatableEscape("com.goodbird.mindofthecolony.mc.coremod.gui.workerhuts.build"));
