...
import com.goodbird.mindofthecolony.mc.core.colony.buildings.moduleviews.MinerGuardAssignModuleView;
        ...
        if (guard != null)
        {
            ...
            if (guardbuilding.getMinePos() == null)
            {
                if (assignedGuards < getMaxGuards())
                {
                    ...
                    button.setText(Component.translatableEscape("com.goodbird.mindofthecolony.mc.coremod.gui.hiring.buttonunassign"));
            ...
            else if (guardbuilding.getMinePos().equals(buildingView.getPosition()))
            {
                ...
                button.setText(Component.translatableEscape("com.goodbird.mindofthecolony.mc.coremod.gui.hiring.buttonassign"));
