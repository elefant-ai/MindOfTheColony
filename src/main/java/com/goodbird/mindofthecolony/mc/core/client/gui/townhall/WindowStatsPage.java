...
import com.goodbird.mindofthecolony.mc.core.colony.buildings.moduleviews.CombinedHiringLimitModuleView;
...
import static com.goodbird.mindofthecolony.mc.api.util.constant.TranslationConstants.COM_MINECOLONIES_COREMOD_GUI_TOWNHALL_POPULATION_CHILDS;
...
public class WindowStatsPage extends AbstractWindowTownHall
{
    ...
    static
    {
        INTERVAL.put("com.goodbird.mindofthecolony.mc.coremod.gui.interval.yesterday", 1);
        INTERVAL.put("com.goodbird.mindofthecolony.mc.coremod.gui.interval.lastweek", 7);
        INTERVAL.put("com.goodbird.mindofthecolony.mc.coremod.gui.interval.100days", 100);
        INTERVAL.put("com.goodbird.mindofthecolony.mc.coremod.gui.interval.alltime", -1);
    }
     ...
     */
    public String selectedInterval = "com.goodbird.mindofthecolony.mc.coremod.gui.interval.yesterday";
