...
import com.goodbird.mindofthecolony.mc.core.entity.ai.workers.guard.EntityAIKnight;
...
import static com.goodbird.mindofthecolony.mc.api.util.constant.GuardConstants.KNIGHT_HP_BONUS;
...
public class JobKnight extends AbstractJobGuard<JobKnight> implements IJobWithColonyFlag
{
     ...
     * Desc of knight job.
     */
    public static final String DESC = "com.goodbird.mindofthecolony.mc.coremod.job.knight";
