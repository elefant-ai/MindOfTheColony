...
import com.goodbird.mindofthecolony.mc.api.blocks.interfaces.IBuildingBrowsableBlock;
...
import com.goodbird.mindofthecolony.mc.api.colony.buildings.modules.IBuildingModule;
import com.goodbird.mindofthecolony.mc.api.colony.buildings.modules.ICraftingBuildingModule;
...
import com.goodbird.mindofthecolony.mc.api.research.IGlobalResearch;
import com.goodbird.mindofthecolony.mc.api.util.FoodUtils;
...
import com.goodbird.mindofthecolony.mc.core.client.gui.WindowBuildingBrowser;
import com.goodbird.mindofthecolony.mc.core.client.gui.containers.WindowCitizenInventory;
import com.goodbird.mindofthecolony.mc.core.client.render.worldevent.ColonyBorderRenderer;
import com.goodbird.mindofthecolony.mc.core.client.render.worldevent.WorldEventContext;
import com.goodbird.mindofthecolony.mc.core.colony.crafting.CustomRecipe;
import com.goodbird.mindofthecolony.mc.core.colony.crafting.CustomRecipeManager;
import com.goodbird.mindofthecolony.mc.core.util.DomumOrnamentumUtils;
import com.goodbird.mindofthecolony.mc.core.util.SchemAnalyzerUtil;
...
import static com.goodbird.mindofthecolony.mc.api.research.util.ResearchConstants.SATURATION;
import static com.goodbird.mindofthecolony.mc.api.sounds.ModSoundEvents.CITIZEN_SOUND_EVENT_PREFIX;
import static com.goodbird.mindofthecolony.mc.api.util.constant.TranslationConstants.*;
import static com.goodbird.mindofthecolony.mc.api.util.constant.translation.DebugTranslationConstants.*;
import static com.goodbird.mindofthecolony.mc.core.colony.buildings.modules.BuildingModules.RESTAURANT_MENU;
    ...
    public static void onItemTooltipEvent(final ItemTooltipEvent event)
    {
        ...
        if (stack.getItem() instanceof BlockItem)
        {
            ...
            if (event.getEntity().isCreative() && InventoryUtils.hasItemInItemHandler(new InvWrapper(event.getEntity().getInventory()), ModItems.scanTool.get()))
            {
                ...
                event.getToolTip().add(Component.translatableEscape("com.goodbird.mindofthecolony.mc.coremod.tooltip.schematic.tier", tier));
            }
        }
        ...
        if (WindowCitizenInventory.activeCitizenInventory != null && ItemStackUtils.ISFOOD.test(stack))
        {
            ...
            {
                event.getToolTip().add(Component.translatable("com.goodbird.mindofthecolony.mc.coremod.item.tooltip.wrongfood").withStyle(ChatFormatting.RED));
                return;
            }
            ...
            if (FoodUtils.canEatLevel(event.getItemStack(), homeBuildingLevel))
            {
                ...
                {
                    event.getToolTip().add(Component.translatable("com.goodbird.mindofthecolony.mc.coremod.item.tooltip.nomenu").withStyle(ChatFormatting.RED));
                }
            }
            else
            {
                event.getToolTip().add(Component.translatable("com.goodbird.mindofthecolony.mc.coremod.item.tooltip.needbetterfood").withStyle(ChatFormatting.RED));
            }
        }
    }
