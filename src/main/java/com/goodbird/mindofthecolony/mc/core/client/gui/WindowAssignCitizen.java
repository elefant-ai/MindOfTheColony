...
import com.goodbird.mindofthecolony.mc.core.colony.buildings.moduleviews.LivingBuildingModuleView;
...
import static com.goodbird.mindofthecolony.mc.api.util.constant.TranslationConstants.COM_MINECOLONIES_COREMOD_GUI_TOWNHALL_CITIZEN_UNEMPLOYED;
...
public class WindowAssignCitizen extends AbstractWindowSkeleton implements ButtonHandler
{
    ...
    {
        settingsButton.setText(Component.translatable("com.goodbird.mindofthecolony.mc.coremod.gui.hiringmode." + building.getHiringMode().name().toLowerCase(Locale.US)));
    }
    ...
    public void onOpened()
    {
        ...
        unassignedCitizenList.setDataProvider(new ScrollingList.DataProvider()
        {
            ...
            public void updateElement(final int index, @NotNull final Pane rowPane)
            {
                ...
                if (work != null)
                {
                    ...
                    workString = Component.translatableEscape("com.goodbird.mindofthecolony.mc.coremod.gui.home.new", newDistance);
                }

                MutableComponent homeString = Component.translatableEscape("com.goodbird.mindofthecolony.mc.coremod.gui.home.homeless");
                ...
                if (home != null)
                {
                    if (work != null)
                    {
                        ...
                        homeString = Component.translatableEscape("com.goodbird.mindofthecolony.mc.coremod.gui.home.currently", oldDistance);
                ...
                {
                    hireButton.disable();
                    PaneBuilders.tooltipBuilder().hoverPane(hireButton).build().setText(Component.translatableEscape("com.goodbird.mindofthecolony.mc.coremod.gui.home.hire.warning"));
                }
            }
        });
        ...
        assignedCitizenList.setDataProvider(new ScrollingList.DataProvider()
        {
            ...
            public void updateElement(final int index, @NotNull final Pane rowPane)
            {
                ...
                final BlockPos work = citizen.getWorkBuilding();
                fireButton.setText(Component.translatableEscape("com.goodbird.mindofthecolony.mc.coremod.gui.hiring.buttonunassign"));
                ...
                if (((!colony.getSettings().getSetting(BuildingTownHall.AUTO_HOUSING_MODE).getValue() && building.getHiringMode() == HiringMode.DEFAULT) || (building.getHiringMode() == HiringMode.MANUAL)))
                {
                    ...
                    {
                        fireButton.disable();
                        PaneBuilders.tooltipBuilder().hoverPane(fireButton).build().setText(Component.translatable("com.goodbird.mindofthecolony.mc.coremod.gui.home.travelling"));
                    }
                    else
                    {
                        fireButton.enable();
                ...
                {
                    fireButton.disable();
                    PaneBuilders.tooltipBuilder().hoverPane(fireButton).build().setText(Component.translatableEscape("com.goodbird.mindofthecolony.mc.coremod.gui.home.hire.warning"));
                }
            }
        });
    }
