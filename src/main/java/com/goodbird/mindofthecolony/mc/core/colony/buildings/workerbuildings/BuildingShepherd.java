...
public class BuildingShepherd extends AbstractBuilding
{
     ...
     * Automatic dyeing.
     */
    public static final ISettingKey<BoolSetting> DYEING = new SettingKey<>(BoolSetting.class, new ResourceLocation(com.goodbird.mindofthecolony.mc.api.util.constant.Constants.MOD_ID, "dyeing"));

    /**
     * Automatic shearing.
     */
    public static final ISettingKey<BoolSetting> SHEARING = new SettingKey<>(BoolSetting.class, new ResourceLocation(com.goodbird.mindofthecolony.mc.api.util.constant.Constants.MOD_ID, "shearing"));
