...
/**
 * Definitions of all origins, personality traits, and penalties.
 * Initialized with hardcoded defaults, then overwritten by config on server start.
 */
public final class BackgroundDefinitions {
    ...
    // Mutable runtime data, initialized with defaults as safety net
    private static List<BackgroundEntry> origins = getDefaultOrigins();
    private static List<BackgroundEntry> personalityTraits = getDefaultPersonalityTraits();
    private static List<PenaltyEntry> penalties = getDefaultPenalties();

    // --- Public read-only accessors ---

    public static List<BackgroundEntry> getOrigins() {
        return Collections.unmodifiableList(origins);
    }

    public static List<BackgroundEntry> getPersonalityTraits() {
        return Collections.unmodifiableList(personalityTraits);
    }

    public static List<PenaltyEntry> getPenalties() {
        return Collections.unmodifiableList(penalties);
    }

    /**
     * Called by BackgroundConfigLoader to replace the lists with config-loaded data.
     */
    public static void load(List<BackgroundEntry> newOrigins,
                            List<BackgroundEntry> newTraits,
                            List<PenaltyEntry> newPenalties) {
        origins = new ArrayList<>(newOrigins);
        personalityTraits = new ArrayList<>(newTraits);
        penalties = new ArrayList<>(newPenalties);
    }

    // --- Default data factories ---

    public static List<BackgroundEntry> getDefaultOrigins() {
        return List.of(
    ...
    public static List<BackgroundEntry> getDefaultPersonalityTraits() {
        return List.of(
    ...
    public static List<PenaltyEntry> getDefaultPenalties() {
        return List.of(
